...
export const translations = {
  en: {
    ...
    platforms: "Platforms",
    dashboard: "Dashboard",
    recordsByPlatform: "Records by platform",
    recordsByKey: "Records by search key × platform",
    totalRecords: "Total records",
    searchKeysLabel: "Search keys",
    keysWithData: "Keys with data",
    searchKeyCol: "Search Key",
  ...
  de: {
    ...
    dashboard: "Dashboard",
    recordsByPlatform: "Datensätze pro Plattform",
    recordsByKey: "Datensätze pro Suchbegriff × Plattform",
    totalRecords: "Datensätze gesamt",
    searchKeysLabel: "Suchbegriffe",
    keysWithData: "Begriffe mit Daten",
    searchKeyCol: "Suchbegriff",
